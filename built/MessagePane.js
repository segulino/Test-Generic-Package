...
var MessagePaneView = function (props) {
    return React.createElement("div", { className: Chat_1.classList('wdrgy-wc-message-pane', props.activityWithSuggestedActions && 'show-actions') },
        props.children,
        React.createElement("div", { className: "wdrgy-wc-suggested-actions" },
