...
var HScroll = (function (_super) {
    ...
    HScroll.prototype.scrollBy = function (direction) {
        var _this = this;
        var easingClassName = 'wdrgy-wc-animate-scroll';
        //cancel existing animation when clicking fast
        if (this.animateDiv) {
            easingClassName = 'wdrgy-wc-animate-scroll-rapid';
        ...
        if (Math.abs(dest - scrollLeft) < 60) {
            easingClassName = 'wdrgy-wc-animate-scroll-near';
        }
    ...
    HScroll.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            ...
            React.createElement("div", { className: "wdrgy-wc-hscroll-outer" },
                React.createElement("div", { className: "wdrgy-wc-hscroll", ref: function (div) { return _this.scrollDiv = div; } }, this.props.children)),
