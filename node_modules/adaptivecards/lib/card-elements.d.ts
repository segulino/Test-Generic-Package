...
export declare function createActionInstance(json: any): Action;
...
export declare abstract class CardElement {
    ...
    private handleOverflow(maxHeight);
...
export declare class TextBlock extends CardElement {
    ...
    private truncateIfSupported(maxHeight);
}
...
export declare class AdaptiveCard extends ContainerWithActions {
    ...
    static onAnchorClicked: (rootCard: AdaptiveCard, anchor: HTMLAnchorElement) => boolean;
    ...
    protected readonly allowCustomStyle: boolean;
    protected readonly hasBackground: boolean;
    onAnchorClicked: (rootCard: AdaptiveCard, anchor: HTMLAnchorElement) => boolean;
